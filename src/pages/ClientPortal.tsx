          ...
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {client.company && (
                <div>
                  ...
                  <p className="text-base font-semibold">{client.company}</p>
                </div>
              )}
              {client.niche && (
                <div>
                  <p className="text-sm font-medium text-muted-foreground mb-1">Nicho</p>
                  <p className="text-base font-semibold">{client.niche}</p>
                </div>
              )}
              <div>
            ...
            {client.strategic_notes && (
              <div className="mt-6 pt-6 border-t border-border/50">
                <p className="text-sm font-medium text-muted-foreground mb-2">Notas Estratégicas</p>
