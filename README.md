...
- [Deployment (Desenvolvimento)](#-deployment-desenvolvimento)
...
O TrafficPro inclui um **Deploy Pack** completo para deploy em produção usando Docker e Caddy.
...
- ✅ **Docker multi-stage** - Build otimizado com imagem Alpine
- ✅ **Caddy** - Servidor web com suporte a HTTP/2
- ✅ **Compressão gzip** - Otimização automática de assets
- ✅ **Headers de segurança** - Proteção contra XSS, Clickjacking, etc.
- ✅ **Health checks** - Monitoramento automático do container
- ✅ **Script de deploy** - Automatização completa

### Documentação Completa

📖 **[ops/README_DEPLOY.md](ops/README_DEPLOY.md)** - Guia detalhado de deploy  
📋 **[DEPLOY_CHECKLIST.md](DEPLOY_CHECKLIST.md)** - Checklist de verificação

### Configuração de HTTPS

Para HTTPS em produção, configure o Caddyfile com seu domínio:
...
O Caddy irá obter certificados SSL automaticamente via Let's Encrypt.
...
Para desenvolvimento e preview:

1. Clique no botão **"Publish"** no canto superior direito
2. Configure seu domínio personalizado em **Settings > Domains**
